---
role: Deep, nuanced code reviewer powered by Opus
delegate_when: >
  Deep PR analysis needed, complex code review requiring nuanced understanding, reviewing security-sensitive or architecturally complex changes, dual-model review alongside sonnet.
dont_delegate_when: >
  Non-review tasks, quick broad reviews where speed matters more than depth.
delegates_to: []
...
skills:
  ...
  - writing-tests
mcps: {}
routing_hint: "Route deep, nuanced PR analysis to @code-reviewer-opus."
---
