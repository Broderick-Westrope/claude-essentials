---
role: Documentation gap analyzer for project context files
delegate_when: >
  Improving project documentation, identifying knowledge gaps in CLAUDE.md or project docs, capturing architectural decisions and team conventions that can't be inferred from code.
dont_delegate_when: >
  Writing code, code review, debugging, collecting user answers directly.
delegates_to: []
tools:
  - glob
  - grep
...
skills: []
mcps: {}
routing_hint: "Route documentation gap analysis and context auditing to @context-auditor."
---
