---
role: Fast, broad code reviewer powered by Sonnet
delegate_when: >
  Fast PR analysis needed, broad coverage review, dual-model review alongside opus, speed matters more than depth.
dont_delegate_when: >
  Non-review tasks, when deep nuanced analysis is the sole requirement.
delegates_to: []
...
skills:
  ...
  - writing-tests
mcps: {}
routing_hint: "Route fast, broad PR analysis to @code-reviewer-sonnet."
---
