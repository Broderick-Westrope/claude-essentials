...
FIRST: Load the code comment skill: Skill(documenting-code-comments)
...
FIRST: Load the documentation skill: Skill(documenting-systems)
...
3. Add diagrams using Skill(visualizing-with-mermaid) for flows
