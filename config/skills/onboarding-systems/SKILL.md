...
```
1. Read the service's CLAUDE.md/AGENTS.md, README, and package.json / go.mod
2. Scan the top-level directory structure
3. Identify the entry point (index.ts / main.go / service.go)
4. Check for architecture docs (docs/, ARCHITECTURE.md)
...
These are the common structural patterns across Go and TypeScript microservices. Use these to quickly orient in any service.
