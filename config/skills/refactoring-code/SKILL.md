...
**If tests are missing:** Add behavior-driven tests first using `Skill(writing-tests)`.
...
**If something breaks:** STOP. Use `Skill(systematic-debugging)`. Don't proceed until understood.
