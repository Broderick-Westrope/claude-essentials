...
For writing style, tone, and voice guidance, use `Skill(writer)` with **The Engineer** persona.
...
- `Skill(writer)` - Writing style, tone, and voice (load The Engineer persona)
- `Skill(visualizing-with-mermaid)` - Architecture and flow diagrams
