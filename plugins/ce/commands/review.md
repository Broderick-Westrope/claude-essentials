...
Launch ALL THREE agents **in parallel** using Task, passing the same review scope to each. Use the exact agent names and model overrides from the **Model Configuration** table above:
