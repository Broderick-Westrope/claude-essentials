...
**Tool reliability:** Load `Skill(ce:configuring-claude)` and read `references/tool-reliability.md` for tool failure patterns

**Error handling:** Load `Skill(ce:handling-errors)` for error handling patterns
