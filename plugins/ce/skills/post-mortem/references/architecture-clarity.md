...
Load the **architecting-systems** skill for guidance on structure, coupling, boundaries, concurrency, and observability patterns. Use its reference files for targeted architectural context.
